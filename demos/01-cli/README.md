...
## Set up a folder structure for your course work
...
Example: UVA HPC login node (replace `mst3k` with your computing ID).
...
Run this on the remote system after you log in:

```bash
du -ah ~/ | sort -hr | head -10 > largest.txt
```

### Copy a file from the remote server

Run this from your local machine (after you exit the SSH session):
